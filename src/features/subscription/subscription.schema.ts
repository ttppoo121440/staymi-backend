...
export const subscriptionHistoryToDTO = z
  .object({
    history: z.array(subscripttionBaseSchema.omit({ user_id: true, created_at: true, updated_at: true })),
...
export type subscriptionHistoryType = z.infer<typeof subscripttionBaseSchema>;
